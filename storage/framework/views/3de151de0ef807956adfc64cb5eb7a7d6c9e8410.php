...
$(document).ready(function() {
    ...
    $.getScript('//connect.facebook.net/en_US/sdk.js', function () {
        ...
        $("#btn-login").click(function(){
            FB.login(processLoginClick, {scope:'public_profile,email,user_friends, publish_actions', return_scopes: true});  
        });
    });
});
...
function processLoginClick (response) {    
    ...
    var data = { uid:uid, 
                 ...
                 _token:'<?php echo e(csrf_token()); ?>', // this is important for Laravel to receive the data
                 permissions:permissions 
               };        
    postData("<?php echo e(url('/facebook')); ?>", data, "post");
}
